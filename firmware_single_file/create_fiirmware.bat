...
esptool.exe --chip esp32 merge_bin  --flash_mode dio --flash_freq 80m --flash_size 4MB  0x1000 bootloader.bin 0x8000 partitions.bin 0xe000 boot_app0.bin 0x10000 firmware.bin -o ../lvgl_mb/firmware/firmware_MicroBlocks_LVGL_%param%_%TIMESTAMP%.bin
del boot_app0.bin
del bootloader.bin
del partitions.bin
del firmware.bin
